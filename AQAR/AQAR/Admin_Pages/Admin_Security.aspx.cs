...
namespace AQAR.Admin_Pages
{
    public partial class Admin_Security : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from Users where uName= '" + username + "' AND pass= '" + OldPassword.Text + "' AND lvl= 'admin'";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cmd.CommandText = "update Users set pass = '" + NewPassword.Text + "'  where uName= '" + username + "' AND pass= '" + OldPassword.Text + "' AND lvl= 'admin'";
                cmd.ExecuteReader();
                Label6.Visible = false;
                Label7.Visible = true;
